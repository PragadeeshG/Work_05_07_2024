...
public class MarketTradeComplianceOrigin {
	...
	public MarketTradeComplianceOrigin() {

	}

	public MarketTradeComplianceOrigin(Integer marketTradeComplianceCode, Integer dataCustodianId,
			Integer excemptCodeId, String excemptionApplicable, Integer businessIndicator, boolean userCode,
			boolean countryCode, String unitName, String custodialAccountMappingId, String creationCr,
